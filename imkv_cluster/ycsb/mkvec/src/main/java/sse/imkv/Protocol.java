 ...
 * IMKVEC protocol.
 *
 * IMKVEC protocol for Java interface
 */
public class Protocol {
  ...
  /**
   * IMKVEC protocol header (general).
   */
  ...
  /**
   * IMKVEC protocol header (key-value update).
   */
