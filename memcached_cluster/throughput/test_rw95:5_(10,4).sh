...
cd  $YCSB_HOME
bin/ycsb load basic -P $YCSB_HOME/workloads/workload2 > ./ycsb_load2.load
bin/ycsb run basic -P $YCSB_HOME/workloads/workload2 > ./ycsb_run2.run
...
#g++ -std=c++11 workload2.cpp -o workload2 -lmemcached -lisal
